...
useEffect(()=>{
  ...
  return (
    ...
    <Button className="text-xl" variant="destructive" onClick={()=>handleUser("applicant")} >Applicant- i'm looking for job</Button>
    <Button className="text-xl" variant="primary" onClick={()=>handleUser("recruiter")}>recruiter- i want to post a job</Button>
    </div>
    </div>
  )
}
